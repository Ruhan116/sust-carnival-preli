...
from app.llm_core import enhance_prose, llm_enabled
...
async def process_ticket(request: TicketRequest) -> TicketResponse:
    ...
    # Layer 4 (optional): LLM prose enhancement. Structured fields are NEVER
    # changed here; any failure silently keeps the deterministic rule prose.
    if llm_enabled():
        try:
